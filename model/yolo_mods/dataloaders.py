...
class LoadImagesAndLabels(Dataset):
    ...
    def __init__(
        ...
        base_directory = '/content/drive/My Drive/Imperial College London/Thesis/data/images/'
        ...
        try:
            ...
            # Replace the base directory of each path with the new Google Drive directory
            f = [os.path.join(base_directory, os.path.basename(x)) for x in f]
