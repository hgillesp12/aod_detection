...
real_path = '/Users/hannahgillespie/aod_detection/model/results/augmented_results_training.csv'
combined_path = '/Users/hannahgillespie/aod_detection/model/results/combined_results_training.csv'
augmented_path = '/Users/hannahgillespie/aod_detection/model/results/real_results_training.csv'

df1 = pd.read_csv(real_path)
df2 = pd.read_csv(combined_path)
df3 = pd.read_csv(augmented_path)
...
plt.savefig('/Users/hannahgillespie/aod_detection/model/results/training_results.png', dpi=300)
